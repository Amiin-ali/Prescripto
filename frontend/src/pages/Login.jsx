...
const Login = () => {
  ...
  return (
    <form>
      <div className='flex flex-col gap-3 lg:mx-70 mt-10 items-start p-8 min-w-[340px] sm:min-w-96 rounded-1xl text-zinc-600 text-sm shadow-lg'>
        ...
        <button className='bg-[#5f6fff] rounded text-white w-full py-2 mt-1'>{state === 'Sign Up' ? "Create Account" : "Login"}</button>
        {
          state === "Sign Up"
