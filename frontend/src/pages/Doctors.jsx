    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={()=>Speciality === 'Pediattricians' ? navigate('/doctors') : navigate('/doctors/Pediattricians')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${Speciality === "Pediattricians" ? "bg-indigo-100 text-black" : ""}`}>Pediattricians</p>
